...
export const CONSENT_FLOW_STEPS = [
  {
    title: '요청을 보냅니다',
    body: '후보 중에 마음이 가는 사람에게 「상세 궁합을 함께 보자」고 청합니다. 보내는 것만으로 상대에게 열리는 것은 없고, 상대의 알림함에 요청이 하나 뜹니다.',
  },
  {
    title: '상대가 답합니다',
  ...
  {
    title: '둘이 같은 결과를 봅니다',
    body: '수락하면 Match 가 되고, 두 사람 사이에 걸리는 관계와 사주풀이가 양쪽에 함께 열립니다. 그때도 정확한 생년월일시와 출생지는 열리지 않습니다.',
  },
] as const;
