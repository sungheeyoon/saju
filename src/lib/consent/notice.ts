 ...
 * 흐려진다.
 */
export const NOTICE_ACK_LABEL = '위 처리방침을 읽고 확인했습니다';

/** 확인 칸 옆의 한 줄 — 무엇을 표시하는 것인지 */
export const NOTICE_ACK_NOTE =
  '확인은 동의가 아니라 안내를 읽었다는 표시입니다. 이 확인 없이는 가입하실 수 없습니다.';
...
export const SIGNUP_CODE_NOTE =
  '초대해 드린 분께 받으신 테스트 코드를 넣어 주세요. 코드는 받으신 날 하루만 살고, 하루에 들어오실 수 있는 인원이 정해져 있습니다.';

/** 안내가 바뀌어 다시 지나는 사람에게 — **가입이 아니라 재확인이다** */
export const NOTICE_AGAIN_NOTE =
  '처리방침이 바뀌었습니다. 계속 이용하시려면 한 번 더 확인해 주세요 — 코드와 닉네임은 그대로 두셔도 됩니다.';
