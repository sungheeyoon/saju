...
export type TonggwanPair = {
   ...
   * 셋의 실효 몫 — **점수 기준이다.**
   *
   * 지장간을 역할 몫으로 펼치고 월지를 두 배로 재고(ADR 0114) 국·합화까지 반영한 값이라, 오행 분포 표의
...
export const TONGGWAN_POLICY = {
   ...
   * 쪽 몫」 분포다. 0.30 에 선을 그으면 8.7% 가 걸리는데, 그것은 종격 발화율
   * (11.8%)과 자릿수가 같다 — **참고일 뿐 채택이 아니다.**
   *
   * 2026-09-25 에 다시 쟀다 — 월지 ×2 · 지장간 60:30:10(ADR 0114)이 실효 분포를 옮겼다. 앞의 값은
   * 0.15 0.896 · 0.2 0.62 · 0.25 0.378 · 0.3 0.102 · 0.35 0.022 · 중앙 0.218 · 드러나지 않음 0.203 이었다.
   * 팽팽한 쌍이 줄었다(0.25 이상 37.8% → 29%).
   */
  calibration: {
    sample: 3000,
    ...
    facingAtLeast: { 0.15: 0.877, 0.2: 0.628, 0.25: 0.29, 0.3: 0.087, 0.35: 0.021 },
    median: 0.222,
    /**
