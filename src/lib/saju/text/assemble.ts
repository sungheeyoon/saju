...
export const UNCOVERED_FACTS_BY_PATH: readonly {
  ...
  { paths: ['stages'] },
  { paths: ['sinsal'] },
  // 대운·세운·월운은 아직 침묵한다. 지금 도는 한 칸을 말하던 현재운 문장은 화면이
  // 쓰지 않아 걷었고, 아홉 칸과 열두 칸을 다 말하는 것은 "고르지 않는다"가 화면을
  // 덮어 버리는 자리라 따로 정할 일이다.
  {
    paths: ['daeun', 'saeun', 'wolun'],
    note: '대운·세운·월운 — 표와 근거가 들고 문장은 아직 읽지 않는다',
  },
  // 지금 도는 칸을 말하던 현재운 문장은 화면이 쓰지 않아 걷었다. 값은 운 표와 근거가 든다.
  {
    paths: ['now'],
    note: '현재운 — 운 표와 근거가 들고 문장은 짓지 않는다',
  },
];
