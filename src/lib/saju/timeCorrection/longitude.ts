 ...
 *
 * 시계는 표준자오선의 태양을 따른다. 서울은 동경 135° 기준시를 쓰면서 실제로는
 * 127°에 있으므로, 시계가 정오를 가리킬 때 서울 하늘의 태양은 아직 남중 전이다.
 *
 * 보정량 자체는 천문학적으로 정해진다(경도 1° = 4분). 갈리는 것은 시주를
 * 태양시 기준으로 볼 것인가, 출생기록의 시계 시각 그대로 볼 것인가다.
 */
