...
**2. 타고난 결** — 어떤 기질이고 그게 하루에 어떻게 나오는지. 서너 문장.

**3. 잘하는 것 셋** — 줄마다 「무엇을 잘한다 → 왜 그런가 → 어디에 쓰면 되는가」.

**4. 걸리는 것 셋** — 줄마다 「무엇이 문제다 → 언제 그렇게 되는가 → 그때 어떻게 하는가」.

**5. 일과 돈** — 어떤 판에서 힘이 나고 어떤 판에서 빠지는지. **직업 이름을 못박지 말고 조건으로 말해라** — 「엔지니어」가 아니라 「정해진 규칙 안에서 남이 못 찾는 오류를 찾는 일」이다.

**6. 사람 관계** — 되풀이되는 모양 하나와, 그걸 아는 것만으로 달라지는 것 하나.

**7. 지금** — 기준 시각을 밝히고, 지금 도는 대운·세운·월운이 무슨 때인지. **이번 달과 올해에 무엇을 밀어붙이고 무엇을 미루면 좋은지**까지. 「문서를 조심하라」 같은 말을 쓸 거면 왜 그런지 한 줄로 붙여라.
