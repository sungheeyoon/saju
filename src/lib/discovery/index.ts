 ...
 * 10.3% · 2.5% 다. 잰 곳은 비교기의 `adults` 시나리오 5000 쌍(시드 20260925), 세기는 옛 엔진 기본과
 * 지금 기본(월지 ×2 · 지장간 60:30:10, ADR 0114) 두 벌이 같은 경계를 냈다(`docs/notes/2026-09-25-compat-formula-comparison.md`).
