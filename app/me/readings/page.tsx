 ...
 * ## 책장으로 선다 (5차 warm)
 *
 * 줄 목록이 **책장**이 됐다 — 한 편이 한 권이고 표지 색이 대상의 일간이다(`shelf.tsx`). 그 색 하나를
 * 위해 명식을 읽는다: 사람 목록이 쓰는 문(`storedInputsOf`)을 한 번 더 부르고, 못 읽으면 회색 표지다.
 * 본문은 여전히 안 싣는다.
 */
export default async function ReadingsPage() {
  ...
  return (
    <main className="app-shell flex flex-1 flex-col gap-10 py-9 sm:py-14">
