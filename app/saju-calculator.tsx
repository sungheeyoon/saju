 ...
 *
 * 회원 쪽은 **「사주 보기」** 다. 「이 사람 명식 보기」였는데, 누구인지(「이 사람」)와
 * 무엇인지(「명식」)를 한 버튼에 다 욱여넣은 이름이었다 — 누구인지는 바로 위 폼에
 * 적혀 있고, 화면이 내내 부르는 말은 「명식」이 아니라 **「사주」**다. 두 사람 쪽도
 * 같은 규칙을 쓴다(`compat-picker.tsx` 의 「궁합 보기」).
 */
